...
function abrilModal( id_usuario = -1 , modo = 0 ){
  ...
  //   $("#nombre_usuario_modal").val( dataUsuarioModal.nombre );
    ...
    $("#app_usuario_modal").val( dataUsuarioModal.appaterno );
...
function guardarUsuario(){
  ...
  let nombre_perfil = $("#empresa_modal option:selected").text().trim();
  let nombre_empresa = $("#perfil_modal option:selected").text().trim();

  let estadoData = $("#estado_usuario_modal option:selected").text().trim().toLowerCase();
  ...
  ajaxSaveUsuarios( modo, id_usuario, user, nombre, appaterno, apmaterno, rut, estado, perfil_modal, empresa_modal, nombre_perfil, nombre_empresa, estadoData );

}

var contadorUsuarios=200;
function ajaxSaveUsuarios( modo, id_usuario, user, nombre, appaterno, apmaterno, rut, estado, perfil_modal, empresa_modal, nombre_perfil, nombre_empresa, estadoData ){
          ...
          //  $("#addModal").modal('hide');
            ...
            if( modo == 0){
              ...
              dataUsuario = [{
                        ...
                        console.log( "creando: ", dataUsuario );
              ...
              dataUsuario = [{
                        ...
                        console.log( "editando: ", dataUsuario );
